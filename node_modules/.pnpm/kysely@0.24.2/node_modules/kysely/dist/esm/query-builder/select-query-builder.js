...
import { parseHaving, parseReferentialComparison, parseWhere, } from '../parser/binary-operation-parser.js';
...
export class SelectQueryBuilder {
    ...
    orWhereRef(lhs, op, rhs) {
        return new SelectQueryBuilder({
            ...this.#props,
            queryNode: QueryNode.cloneWithOrWhere(this.#props.queryNode, parseReferentialComparison(lhs, op, rhs)),
        });
    }
    whereExists(arg) {
        return new SelectQueryBuilder({
    ...
    orHavingRef(lhs, op, rhs) {
        return new SelectQueryBuilder({
            ...this.#props,
            queryNode: SelectQueryNode.cloneWithOrHaving(this.#props.queryNode, parseReferentialComparison(lhs, op, rhs)),
        });
    }
    havingExists(arg) {
        return new SelectQueryBuilder({
